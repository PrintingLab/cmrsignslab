            ...
            <div class="card-body ">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input class="form-control" name="P_Team_Involved" type="text" placeholder="{{ __('Team Involved') }}" value="{{$resultproducto[0]->P_Team_Involved}}">
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div ng-hide="yesForm">
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <input class="form-control" name="Yes_hours" type="text" placeholder="{{ __('4 Hours') }}" value="{{$resultproducto[0]->Yes_hours}}">
                  </div>
                </div>
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Approved By') }}</label>
                  <div class="col-sm-7">
                    <input class="form-control" name="Yes_P_approved" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->Yes_P_approved}}">
                  </div>
                </div>
              </div>
              <div ng-hide="noForm">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input class="form-control" name="F_Materials Used" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->F_Materials_Used}}">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input class="form-control" name="F_Defects" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->F_Defects}}">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input class="form-control" name="F_Repairs" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->F_Repairs}}">
                  </div>
                </div>
              </div>
              <div class="row">
                <label class="col-sm-2 col-form-label">{{ __('Duration Time (hours)') }}</label>
                <div class="col-sm-7">
                  <input class="form-control" name="F_Duration_Time" type="text" placeholder="{{ __('4 Hours') }}" value="{{$resultproducto[0]->F_Duration}}">
                </div>
              </div>
              <div class="row">
                <label class="col-sm-2 col-form-label">{{ __('Approved By') }}</label>
                <div class="col-sm-7">
                  <input class="form-control" name="F_Approved_By" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->F_Approved}}">
                </div>
              </div>
              <h3>Assembling</h3>
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input class="form-control" name="A_Team_Involved" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->A_Team_Involved}}">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input class="form-control" name="A_Materials Used" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->A_Materials_Used}}">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input class="form-control" name="A_Defects" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->A_Defects}}">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                    <input class="form-control" name="A_Repairs" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->A_Repairs}}">
                  </div>
                </div>
              </div>
              <div class="row">
                <label class="col-sm-2 col-form-label">{{ __('Duration Time (hours)') }}</label>
                <div class="col-sm-7">
                  <input class="form-control" name="A_Duration_Time" type="text" placeholder="{{ __('4 Hours') }}" value="{{$resultproducto[0]->A_Duration}}">
                </div>
              </div>
              <div class="row">
                <label class="col-sm-2 col-form-label">{{ __('Approved By') }}</label>
                <div class="col-sm-7">
                  <input class="form-control" name="A_Approved_By" type="text" placeholder="{{ __('Customer Name') }}" value="{{$resultproducto[0]->A_Approved}}">
                </div>
              </div>
            </div>
